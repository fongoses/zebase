...
function output_pre_installation(){
 ...
 <div class="standard_box" style="width:800px; margin-left:200px; margin-top:50px;">
        ...
        <ul>
        <li>Base URL (make sure it ends with a forward slash "/")</li>
        <li>Database name</li>
...
function output_finish(){
 ...
 <div class="standard_box" style="width:800px; margin-left:200px; margin-top:50px;">
        ...
        <a href="#" target="_new" onClick="window.open('<?php echo $_SESSION['base_url']; ?>index.php/fish/login','form','width=1200,height=1200,left=10,top=163,location=no, menubar=yes,status=yes,toolbar=yes,scrollbars=yes,resizable=yes');" class="jq_buttons" style=" font-size:20px;">Go</a>
        </div>
    </div>
<?php
}
